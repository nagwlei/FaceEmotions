...
% Output:
% -myArrayLBPhalf: Array the MAE error
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function myArrayLBPhalf = LBP_half_General_v2(faces, newfaces, images, ...
    cellSizeStart, cellSizeEnd, nneighbours, radius, CVO)

    cellSize = cellSizeStart;
    myArrayLBPhalf = zeros(1, ((cellSizeEnd - cellSizeStart)+1));
     ...
     for zx = 1:((cellSizeEnd - cellSizeStart)+1)
        ...
        myArrayLBPhalf(1, zx) = sum(errLBP)/sum(CVO.TestSize);

        disp(strcat('MAE of       LBP:    ', sprintf('%f', myArrayLBPhalf(1, zx))))
