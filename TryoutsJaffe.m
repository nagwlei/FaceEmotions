...
HybridMAE = Hybrid_LBP_HOG_BSIFT(facesjaffe, newfacesjaffe, jaffeimgs, myMatrixLBPjaffe, ...
    2, 2, myMatrixHOGjaffe, 6, 6, BSIFfSizeStart, BSIFbitsStart, ...
    resultsBSIF, resultsBSIF2, CVOjaffe);
...
Hybrid_pyramid_MAE = Hybrid_LBP_HOG_BSIFT_Pyramid(facesjaffe, newfacesjaffe, ...
    jaffeimgs, myMatrixLBPjaffe, myMatrixLBP_halfjaffe, myMatrixLBP_quartjaffe,... 
    myMatrixLBPPyramidjaffe, 2, 2, myMatrixHOGjaffe, ...
    6, 6, 5, ...
    myMatrixBSIFjaffe, myMatrixBSIFjaffe, myMatrixBSIF_halfjaffe, myMatrixBSIF_half2jaffe, ...
